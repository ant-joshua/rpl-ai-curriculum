<script lang="ts">
	...
	function buildBlocks() {
		...
		for (let i = 0; i < totalBlocks; i++) {
			...
			// A block is completed if all sessions in all its modules are completed
			let allDone = true;
			...
			// Check previous block completion (for locking)
			if (i > 0) {
...
<div class="progress-quiz-page">
	<h1>📊 Progress Quiz</h1>
	<p class="subtitle">Uji pemahaman setiap {BLOCK_SIZE} modul. 10 soal acak, 5 menit, minimal 70% untuk lulus.</p>
