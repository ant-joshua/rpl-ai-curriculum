...
<style>
  ...
  .timer.timer-warning { color: #e74c3c; animation: pulse 1s ease-in-out infinite; }
  ...
  .option-btn.correct .option-char { background: #2ecc71; color: #fff; border-color: #2ecc71; }
  .option-btn.wrong .option-char { background: #e74c3c; color: #fff; border-color: #e74c3c; }
  .option-text { flex: 1; }
  ...
  .pass-msg { color: #2ecc71; font-weight: 600; font-size: 16px; margin-bottom: 16px; }
  .fail-msg { color: #e74c3c; font-weight: 600; font-size: 16px; margin-bottom: 16px; }
