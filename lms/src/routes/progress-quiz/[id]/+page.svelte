<script lang="ts">
	...
	let score = $state(0);
	let timeLeft = $state(300); // 5 minutes = 300 seconds
	...
	function finishQuiz() {
		timerActive = false;
		if (timer) clearInterval(timer);
		// Push last answer if not already pushed
...
<div class="progress-quiz-page">
	...
	{:else if finished}
		<div class="result-card">
			...
			{:else}
				<p class="fail-msg">❌ Belum lulus. Minimal 70% diperlukan. Coba lagi!</p>
			{/if}
