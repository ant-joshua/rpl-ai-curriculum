<script lang="ts">
	...
	import { DataTable, Skeleton, EmptyState, Select } from '$lib/components/ui';
	...
	{:else}
		<div class="page-header">
			...
			<div class="header-actions">
				<Select options={[{ value:'1', label: t('nilai.semester_ganjil') }, { value:'2', label: t('nilai.semester_genap') }]} bind:value={selectedSemester} onchange={() => loadRekap()} />
			</div>
		</div>
