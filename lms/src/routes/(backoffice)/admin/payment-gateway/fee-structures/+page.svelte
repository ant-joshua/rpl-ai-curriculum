...
<style>
	...
	.pg-fee-name { font-size: 15px; font-weight: 600; color: var(--text-primary, #1a1a2e); margin: 4px 0 0; }
	.pg-fee-code { font-size: 12px; font-family: 'SF Mono', 'Fira Code', monospace; color: var(--text-secondary, #64748b); }
	.pg-fee-amount { font-size: 22px; font-weight: 700; color: var(--accent, #4F46E5); letter-spacing: -0.5px; margin: 4px 0; }
	.pg-fee-desc { font-size: 12px; color: var(--text-secondary, #64748b); margin: 0; line-height: 1.4; }
	.pg-fee-meta { display: flex; gap: 8px; flex-wrap: wrap; margin-top: 4px; }
	.pg-fee-meta span { font-size: 11px; color: var(--text-secondary, #64748b); background: rgba(0,0,0,0.04); padding: 2px 8px; border-radius: 4px; }

	.pg-badge { display: inline-block; padding: 3px 10px; border-radius: 20px; font-size: 11px; font-weight: 600; }
	.pg-badge-type { background: rgba(113,112,255,0.12); color: #4F46E5; }
	...
	.pg-toggle-input { accent-color: var(--accent, #4F46E5); }
	...
	.pg-btn-icon { display: inline-flex; align-items: center; justify-content: center; width: 28px; height: 28px; border-radius: 6px; background: transparent; border: none; color: var(--text-secondary, #64748b); cursor: pointer; transition: all 0.15s; }
