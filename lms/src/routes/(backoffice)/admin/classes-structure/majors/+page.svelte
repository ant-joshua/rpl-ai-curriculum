<script lang="ts">
	...
	const typeColors: Record<string, string> = {
		...
		keahlian: 'background: rgba(79,70,229,0.1); color: var(--accent)',
		agama: 'background: rgba(16,185,129,0.1); color: var(--success)',
		olahraga: 'background: rgba(245,158,11,0.1); color: var(--warning)',
		seni: 'background: rgba(236,72,153,0.1); color: var(--accent)',
	};
...
<style>
	...
	.modal { background: var(--surface); border: 1px solid var(--border); border-radius: 14px; width: 100%; max-width: 460px; box-shadow: 0 0 0 1px var(--border); }
