<script lang="ts">
	...
	const typeColors: Record<string, string> = {
		pengetahuan: 'background: rgba(79,70,229,0.1); color: var(--accent)',
		keterampilan: 'background: rgba(16,185,129,0.1); color: var(--success)',
		sikap: 'background: rgba(245,158,11,0.1); color: var(--warning)',
	};
	...
	const compTypeColors: Record<string, string> = {
		'3': 'background: rgba(79,70,229,0.1); color: var(--accent)',
		'4': 'background: rgba(16,185,129,0.1); color: var(--success)',
		'1': 'background: rgba(245,158,11,0.1); color: var(--warning)',
		'2': 'background: rgba(236,72,153,0.1); color: var(--accent)',
	};
...
<style>
	...
	.kd-code { font-weight: 600; background: rgba(79,70,229,0.1); color: var(--accent); }
	...
	.btn-danger-icon:hover { color: var(--danger); border-color: rgba(239,68,68,0.3); background: rgba(239,68,68,0.1); }
	...
	.modal { background: var(--surface); border: 1px solid var(--border); border-radius: 14px; width: 100%; max-width: 540px; box-shadow: 0 0 0 1px var(--border); }
