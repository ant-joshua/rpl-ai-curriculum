<script lang="ts">
	...
	async function fetchKelas() {
		try {
			const res = await fetch('/api/admin/struktur/kelas');
	...
	async function uploadAndPreview() {
		...
		try {
			...
			const res = await fetch('/api/admin/struktur/import-siswa/preview', {
				method: 'POST',
				body: form,
			});
			const json = await res.json();
	...
	async function doImport() {
		...
		try {
			...
			const res = await fetch('/api/admin/struktur/import-siswa', {
				method: 'POST',
				body: form,
			});
			const json = await res.json();
	...
	{:else if step === 'result'}
		<div class="card result-card">
			...
			<div class="actions">
				...
				<a href="/admin/struktur/kelas/{selectedKelas}" class="btn-cancel">Lihat Kelas</a>
			</div>
		</div>
	{/if}
</div>
