<script lang="ts">
	...
	const jenjangColors: Record<string, string> = {
		'D3': 'background:rgba(16,185,129,0.1);color:var(--success)',
		'D4': 'background:rgba(79,70,229,0.1);color:var(--accent)',
		'S1': 'background:rgba(79,70,229,0.1);color:var(--accent)',
		'S2': 'background:rgba(245,158,11,0.1);color:var(--warning)',
		'S3': 'background:rgba(239,68,68,0.1);color:var(--danger)',
	};
...
<style>
	...
	.modal { background: var(--surface); border: 1px solid var(--border); border-radius: 14px; width: 100%; max-width: 500px; box-shadow: 0 0 0 1px var(--border); }
