...
<style>
	...
	.pp-back { display: inline-block; font-size: 13px; color: var(--accent, var(--accent)); text-decoration: none; margin-bottom: 8px; }
	...
	.pp-loading { display: flex; justify-content: center; align-items: center; gap: 12px; padding: 60px 20px; color: var(--text-secondary, var(--text-secondary)); }
	...
	.pp-info-card { background: var(--bg-secondary, var(--text)); border: 1px solid var(--border-color, rgba(0,0,0,0.06)); border-radius: 10px; padding: 20px; display: flex; flex-direction: column; gap: 12px; }
	.pp-card-title { font-size: 14px; font-weight: 600; color: var(--text-primary, var(--text)); margin: 0; }
	.pp-info-row { display: flex; justify-content: space-between; align-items: center; font-size: 13px; }
	.pp-info-label { color: var(--text-secondary, var(--text-secondary)); }
	.pp-info-value { color: var(--text-primary, var(--border)); font-weight: 500; }
	...
	.pp-btn-danger { color: var(--danger); border-color: rgba(239,68,68,0.2); }
