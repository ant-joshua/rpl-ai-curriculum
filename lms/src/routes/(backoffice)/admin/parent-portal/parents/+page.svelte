...
const parentColumns: ColumnDef<any, any>[] = [
	...
	},
	{
		...
		cell: ({ getValue }) => {
			...
			return v === 1 ? '<span style="color:var(--success);font-weight:600">'+t('common.yes')+'</span>' : '<span style="color:var(--text-secondary)">Tidak</span>';
		}
	},
	{
...
<style>
	...
	.pp-btn-primary { background: var(--accent, var(--accent)); color: white; }
	.pp-btn-primary:hover { background: var(--accent); }
	...
	.pp-modal { background: var(--bg-secondary, var(--text)); border: 1px solid var(--border-color, rgba(255,255,255,0.12)); border-radius: 12px; width: 100%; max-width: 520px; max-height: 90vh; overflow-y: auto; }
	.pp-modal-header { display: flex; align-items: center; justify-content: space-between; padding: 20px 24px 0; }
	.pp-modal-header h3 { font-size: 17px; font-weight: 600; color: var(--text-primary, var(--text)); margin: 0; }
	.pp-btn-close { background: none; border: none; color: var(--text-secondary, var(--text-secondary)); font-size: 24px; cursor: pointer; padding: 0; line-height: 1; }
	.pp-btn-close:hover { color: var(--text-primary, var(--text)); }
	...
	.pp-label { font-size: 12px; font-weight: 500; color: var(--text-secondary, var(--text-secondary)); }
	.pp-input { padding: 8px 12px; border-radius: 8px; border: 1px solid var(--border-color, rgba(255,255,255,0.1)); background: var(--bg-primary, var(--text)); color: var(--text-primary, var(--text)); font-size: 13px; outline: none; transition: border-color 0.15s; }
	.pp-input:focus { border-color: var(--accent, var(--accent)); }
	.pp-input::placeholder { color: var(--text-secondary, var(--text-secondary)); }
	.pp-row { display: flex; gap: 12px; }
	.pp-checkbox { display: flex; align-items: center; gap: 8px; font-size: 13px; color: var(--text-primary, var(--border)); cursor: pointer; margin-top: 16px; }
	.pp-checkbox input { width: 16px; height: 16px; accent-color: var(--accent, var(--accent)); }
